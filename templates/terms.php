...
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 my-8">
  <h1 class="text-3xl font-bold text-indigo-700 mb-6">Terms and Conditions</h1>
  
  <div class="prose prose-indigo max-w-none">
    <h2 class="text-xl font-semibold mt-6 mb-3">Referral Program Terms</h2>
    ...
    <h3 class="text-lg font-medium mt-5 mb-2">5. Program Changes</h3>
    ...
    <ul class="list-disc pl-6 mb-4">
      ...
      <li>Using misleading tactics to gain referrals</li>
      <li>Referring existing customers under new accounts</li>
      <li>Any form of spamming or unsolicited marketing</li>
    </ul>
    
    <h3 class="text-lg font-medium mt-5 mb-2">8. Termination</h3>
    <p class="mb-4">We reserve the right to terminate participation in the referral program for any user found violating these terms.</p>
    
    <h2 class="text-xl font-semibold mt-6 mb-3">Contact Us</h2>
    <p>If you have any questions about these Terms, please contact us through our <a href="complaints.php" class="text-blue-600 hover:underline">Complaints Page</a>.</p>
  </div>
  
  <div class="mt-8 text-center">
    <a href="index.php" class="inline-block px-6 py-3 bg-indigo-600 text-white rounded-xl shadow-lg shadow-indigo-200 font-semibold transition-all duration-300 hover:bg-indigo-700">
