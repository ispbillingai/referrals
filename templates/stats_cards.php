...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
  <div class="bg-white rounded-2xl shadow-lg shadow-indigo-100 p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
    <h2 class="text-lg font-semibold text-gray-600 mb-2">Each Referral</h2>
  ...
  <div class="bg-white rounded-2xl shadow-lg shadow-indigo-100 p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
    <h2 class="text-lg font-semibold text-gray-600 mb-2">Monthly Bonus</h2>
    <p class="text-4xl font-bold text-indigo-600">Ksh 5000</p>
    <span class="text-sm text-gray-500 mt-2">Monthly Bonus</span>
  </div>
</div>
